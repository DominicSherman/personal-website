import {APOLLO_CLIENT, EXPRESS, FIREBASE, GRAPHQL, NODEJS, REACT, REACT_NATIVE, REDUX, TYPESCRIPT} from './icons';

export const projects = [
    {
        labels: [TYPESCRIPT, REACT_NATIVE, APOLLO_CLIENT],
    ...
    {
        labels: [TYPESCRIPT, GRAPHQL, NODEJS, EXPRESS, FIREBASE],
    ...
    },
    {
        ...
        link: 'https://github.com/DominicSherman/email-sender',
        subTitle: 'Express backend for sending emails',
        title: 'email-sender'
    },
    {
        labels: [REACT, REDUX, FIREBASE],
        link: 'https://github.com/DominicSherman/wedding-website',
        subTitle: 'A web application for information about the wedding',
        title: 'wedding-website'
    },
    {
        labels: [REACT_NATIVE, REDUX, FIREBASE],
